		...
		if($scope.empOrgChart.length===2){			
			...
			$scope.countHigherLevel2=$scope.empOrgChart[1].listOfProjectEmp.length;
				...
				for(i=0;i<$scope.empOrgChart[0].listOfProjectEmp.length;i++){
					$scope.countLowerlevel1=$scope.countLowerlevel1+$scope.empOrgChart[0].listOfProjectEmp[i].listOfProjectEmp.length;		
				}
				$scope.count1=$scope.countHigherLevel1+$scope.countLowerlevel1;
				$scope.count1=$scope.countHigherLevel1+$scope.countLowerlevel1;
				for(i=0;i<$scope.empOrgChart[1].listOfProjectEmp.length;i++){
					$scope.countLowerlevel2=$scope.countLowerlevel2+$scope.empOrgChart[1].listOfProjectEmp[i].listOfProjectEmp.length;	
				
				}
				$scope.count2=$scope.countHigherLevel2+$scope.countLowerlevel2;

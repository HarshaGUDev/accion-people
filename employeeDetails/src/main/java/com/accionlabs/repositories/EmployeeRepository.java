...
public interface EmployeeRepository extends CrudRepository<EmployeeDetails, String> {
	...
	@Query(" select new com.accionlabs.data.MinDetails(a.employee_id ,a.employee_name, a.designation_name,a.project, a.reporting_to_by_id ) from EmployeeDetails a where a.employee_id=:employee_id")
	...
	@Query("select new com.accionlabs.data.MinDetails(a.employee_id ,a.employee_name, a.designation_name,a.project, a.reporting_to_by_id ) from EmployeeDetails a  where a.reporting_to_by_id=:reporting_to_by_id  AND a.project=:project order by grade_name desc,employee_name ")
	...
	@Query("select new com.accionlabs.data.MinDetails(a.employee_id ,a.employee_name, a.designation_name,a.project, a.reporting_to_by_id ) from EmployeeDetails a where a.reporting_to_by_id=:empid and a.project=:project  order by grade_name desc,employee_name")

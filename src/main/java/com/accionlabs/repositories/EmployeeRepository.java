...
public interface EmployeeRepository extends CrudRepository<EmployeeDetails, String> {
	...
	@Query(" from EmployeeDetails where email_Id=:email_Id")
	public EmployeeDetails getFullDetailsByEmail(@Param("email_Id") String email_Id);

	@Query(" from EmployeeDetails where email_Id=:email_Id")
	public EmployeeDetails getDetails(@Param("email_Id") String email_Id);
	...
	@Query(" select new com.accionlabs.data.MinDetails(a.employee_id ,a.employee_name, a.designation_name,a.project, a.reporting_to_by_id,a.email_Id) from EmployeeDetails a where a.employee_id=:employee_id")
	public MinDetails getOrgListHigherInfo(@Param("employee_id") String employee_id);
	...
	@Query("select new com.accionlabs.data.MinDetails(a.employee_id ,a.employee_name, a.designation_name,a.project, a.reporting_to_by_id,a.email_Id ) from EmployeeDetails a  where a.reporting_to_by_id=:reporting_to_by_id  AND a.project=:project order by grade_name desc,employee_name ")
	public List<MinDetails> getOrgListLower1(@Param("reporting_to_by_id") String reporting_to_by_id,
	...
	@Query(" Select  distinct a.employee_id from EmployeeDetails a where a.reporting_to_by_id=:manager and a.project=:project")
	public List<String> getOrgListLowerEmpId(@Param("manager") String manager, @Param("project") String project);

	@Query("select new com.accionlabs.data.MinDetails(a.employee_id ,a.employee_name, a.designation_name,a.project, a.reporting_to_by_id,a.email_Id ) from EmployeeDetails a where a.employee_id=:empid")
	public MinDetails getMinDetails(@Param("empid") String empid);

	@Query("select new com.accionlabs.data.MinDetails(a.employee_id ,a.employee_name, a.designation_name,a.project, a.reporting_to_by_id,a.email_Id ) from EmployeeDetails a where a.reporting_to_by_id=:empid and a.project=:project  order by grade_name desc,employee_name")
	...
	public Set<String> getProjectWiseNoReportive(@Param("reporting_to_by_id") String empid,
			@Param("project") String project);

	@Query(" Select  a.employee_id from EmployeeDetails a where a.project=:project and a.reporting_to_by_id is null ")
	public List<String> getNoManagersList(@Param("project") String project);

	@Query(" Select distinct a.employee_id from EmployeeDetails a where a.project=:project  ")
	public List<String> getReporties(@Param("project") String project);
	
	@Query(" Select distinct a.reporting_to_by_id from EmployeeDetails a where a.employee_id=:employee_id")
	public String getHighestOrderList(@Param("employee_id") String employee_id);
}
